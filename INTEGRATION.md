...
**This is the `swift-4` branch of CleanroomText.** It uses **Swift 4.0** and **requires Xcode 9.0 beta** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/emaloney/CleanroomText/swift-4/Documentation/API/index.html) provided by CleanroomText in any Swift file using the statement:
...
Want to learn more about CleanroomText? Check out [the README](https://github.com/emaloney/CleanroomText/blob/swift-4/README.md) or [the API documentation](https://rawgit.com/emaloney/CleanroomText/swift-4/Documentation/API/index.html).
