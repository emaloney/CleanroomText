...
CleanroomText is **Swift 2.0**-compliant and requires **Xcode 7.0 or higher** to be built.
...
```bash
git submodule add https://github.com/emaloney/CleanroomText.git
...
```bash
git clone https://github.com/emaloney/CleanroomText.git
```
...
Once a device-based run destination has been selected, select the appropriate build scheme for the target platform: “CleanroomText-iOS”, “CleanroomText-OSX” or “CleanroomText-tvOS”.
